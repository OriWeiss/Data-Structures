...
public class MinInArray
{
    ...
    public static int minimum(int[] data, int first, int last)
    {
        ...
        // recursively find minimum in each half
            ...
            int minOfFirstHalf = minimum(data, first, mid);
            int minOfSecondHalf = (minimum(data, mid + 1, last));
            result = Math.min(minOfFirstHalf, minOfSecondHalf);
        }
    ...
    public void testForExceptions()
    {
        ...
        catch(Lab05.BadArgumentsForMinimumException e)
        {
