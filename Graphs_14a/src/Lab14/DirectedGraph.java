...
public class DirectedGraph<T> implements GraphInterface<T>
{
    ...
    {
       VertexInterface<T> originVertex = this.vertices.get(origin);
        Queue<T> traversalOrder = new ArrayDeque<T>();
        Stack<VertexInterface> vertexStack = new Stack<VertexInterface>();
        originVertex.visit();
        ...
        return traversalOrder;
        // TODO Lab14a
        //System.out.println("IMPLEMENT getDepthFirstTraversal method");
    ...
    public double getCheapestPath(T begin, T end, Stack<T> path)
    {
        ...
        while(!done && !priorityQueue.isEmpty()){
           ...
           VertexInterface frontVertex = frontEntry.getVertex();
           if(!frontVertex.isVisited()){
               ...
               if(frontVertex.equals(endVertex)){
                   ...
                   Iterator<Double> weightIter = frontVertex.getWeightIterator();
                   while (neighborIter.hasNext()){ //not sure if correct
                       VertexInterface<T> nextNeighbor = neighborIter.next();
                       Double weightOfEdgeToNeighbor = weightIter.next();
                       if(!nextNeighbor.isVisited()){
        ...
        //System.out.println("IMPLEMENT getCheapestPath method");
