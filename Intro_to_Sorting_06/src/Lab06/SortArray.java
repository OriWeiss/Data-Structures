...
public class SortArray {
    ...
    void improvedBubbleSort(T[] a) {
        startStatistics();
        int i = 0;
        boolean swaped = true; //method for improved to tell loop to stop if not swaped
        int leftIndex = 0;
    ...
    //TODO-DONE Project1 D
    //TODO-DONE Project1 F
    }
    ...
    private static Integer[] generateRandomArray(int size)
    {
        ...
        for (int i = 0; i < size; i++) {
            newNumber = rand.nextInt(MAX_VALUE +1);
            result[i]= newNumber;
        }
