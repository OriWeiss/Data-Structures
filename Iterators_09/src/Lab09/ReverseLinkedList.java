...
//==================================
    ...
    public void reverseLinkedListIteratively()
    {
        ...
        this.firstNode = prev; //had to change this line since youtube implementation was slightly different
    ...
    {
        this.firstNode = recursiveReverse(this.firstNode); //changed this slightly
    }

    private Node<T> recursiveReverse(Node<T> currentNode) //changed the return from void to null as youtube implementation
    {
        if(currentNode == null){
            return null;
        }
            ...
            Node rest = recursiveReverse(next);
